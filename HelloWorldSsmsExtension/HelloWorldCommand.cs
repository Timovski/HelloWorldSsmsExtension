...
namespace HelloWorldSsmsExtension
{
    /// <summary>
    /// Command handler
    /// </summary>
    internal sealed class HelloWorldCommand
    {
        ...
        /// </summary>
        public static readonly Guid CommandSet = new Guid("990602fc-c447-448f-a7cc-fecceabdd424");
        ...
        {
            string message = "Hello World from the SSMS Extension!";
